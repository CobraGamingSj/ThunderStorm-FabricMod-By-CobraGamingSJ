...
public class PurpleHeartTrunkPlacer extends TrunkPlacer {
    ...
    public PurpleHeartTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, IntProvider branchCount, IntProvider branchHorizontalLength, UniformIntProvider branchStartOffsetFromTop, IntProvider branchEndOffsetFromTop) {
    ...
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerType.TRUNK_PLACER_TRUNK_PLACER_TYPE;
    }
